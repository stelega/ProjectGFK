...
MenuFrame::MenuFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    m_Radio_1->Connect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_2->Connect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_3->Connect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_4->Connect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_5->Connect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    
    m_wczytaj_1->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_1_click ), NULL, this );
    m_wybierz_1->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_1_click ), NULL, this );
    m_wczytaj_2->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_2_click ), NULL, this );
    m_wybierz_2->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_2_click ), NULL, this );
    m_wczytaj_3->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_3_click ), NULL, this );
    m_wybierz_3->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_3_click ), NULL, this );
    m_wczytaj_4->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_4_click ), NULL, this );
    m_wybierz_4->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_4_click ), NULL, this );
    m_wczytaj_5->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_5_click ), NULL, this );
    m_wybierz_5->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_5_click ), NULL, this );
    
    main_panel->Connect( wxEVT_PAINT, wxPaintEventHandler( MenuFrame::WxPanel_Repaint ), NULL, this );
}

MenuFrame::~MenuFrame()
{
    m_Radio_1->Disconnect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_2->Disconnect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_3->Disconnect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_4->Disconnect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    m_Radio_5->Disconnect( wxEVT_RADIOBUTTON, wxCommandEventHandler( MenuFrame::Radio_Button_clic ), NULL, this );
    
    m_wczytaj_1->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_1_click ), NULL, this );
    m_wybierz_1->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_1_click ), NULL, this );
    m_wczytaj_2->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_2_click ), NULL, this );
    m_wybierz_2->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_2_click ), NULL, this );
    m_wczytaj_3->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_3_click ), NULL, this );
    m_wybierz_3->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_3_click ), NULL, this );
    m_wczytaj_4->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_4_click ), NULL, this );
    m_wybierz_4->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_4_click ), NULL, this );
    m_wczytaj_5->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wczytaj_5_click ), NULL, this );
    m_wybierz_5->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MenuFrame::m_wybierz_5_click ), NULL, this );
    
    main_panel->Disconnect( wxEVT_PAINT, wxPaintEventHandler( MenuFrame::WxPanel_Repaint ), NULL, this );
}

void MenuFrame::m_wczytaj_1_click( wxCommandEvent& event ) { wczytaj(1); }
void MenuFrame::m_wybierz_1_click( wxCommandEvent& event ) {}
void MenuFrame::m_wczytaj_2_click( wxCommandEvent& event ) { wczytaj(2); }
void MenuFrame::m_wybierz_2_click( wxCommandEvent& event ) {}
void MenuFrame::m_wczytaj_3_click( wxCommandEvent& event ) { wczytaj(3); }
void MenuFrame::m_wybierz_3_click( wxCommandEvent& event ) {}
void MenuFrame::m_wczytaj_4_click( wxCommandEvent& event ) { wczytaj(4); }
void MenuFrame::m_wybierz_4_click( wxCommandEvent& event ) {}
void MenuFrame::m_wczytaj_5_click( wxCommandEvent& event ) { wczytaj(5); }
void MenuFrame::m_wybierz_5_click( wxCommandEvent& event ) {}

void MenuFrame::wczytaj( int which_button )
{
    wxImage new_image;
...
void MenuFrame::WxPanel_Repaint( wxPaintEvent& event )
{
    Repaint();
}

void MenuFrame::Repaint_minature( wxImage* miniaturka, wxBufferedDC *dc, wxSize main_panel_size, int which_min)
{
    if ( miniaturka->IsOk() )
    {
...
void MenuFrame::Radio_Button_clic(wxCommandEvent& event)
{
