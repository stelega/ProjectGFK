...
class MyFrame : public wxFrame
{
	...
	public:
		...
		MyFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1120, 670 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
